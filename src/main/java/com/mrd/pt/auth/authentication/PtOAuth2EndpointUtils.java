 ...
 * @since 0.1.2
 */
final class PtOAuth2EndpointUtils {

	static final String ACCESS_TOKEN_REQUEST_ERROR_URI = "https://datatracker.ietf.org/doc/html/rfc6749#section-5.2";

	private PtOAuth2EndpointUtils() {
	}
	...
	static Map<String, Object> getParametersIfMatchesPtUserGrantRequest(HttpServletRequest request,
			String... exclusions) {
		if (!matchesPtUserGrantRequest(request)) {
	...
	static boolean matchesPtUserGrantRequest(HttpServletRequest request) {
		return PtOauth2Constant.GRANT_TYPE_PT_USER.getValue()
			.equals(request.getParameter(OAuth2ParameterNames.GRANT_TYPE))
				&& request.getParameter(OAuth2ParameterNames.USERNAME) != null
				&& request.getParameter(OAuth2ParameterNames.PASSWORD) != null;
	}
